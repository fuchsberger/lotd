# defmodule LotdWeb.Components.Form do
...
#     ~H"""
#     <%= if @form && @field do %>
#       <%# label @form, @field, [class: @classes <> " " <> @class] ++ Map.to_list(@label_opts) do %>
#         <%!-- <%= if @inner_block do %>
...
#       <% end %> --%>
#     <% else %>
#       <label class={@classes <> " " <> @class} {@label_opts}>
#         <%= if @inner_block do %>
#           <%= render_slot(@inner_block) %>
#         <% else %>
#           <%= @label %>
...
#     ~H"""
#     <%# text_input @form, @field, [class: @classes, phx_feedback_for: input_name(@form, @field)] ++ input_validations(@form, @field) ++ @extra_assigns %>
#     """
#   end
...
#     "block text-sm #{type_classes} #{error_classes}"
#   end

#   defp text_input_classes(has_error) do
#     "#{get_error_classes(has_error)} shadow-sm block w-full sm:text-sm disabled:bg-gray-50 disabled:cursor-not-allowed rounded-md"
#   end
...
#     if has_error,
#       do:
#         "border-red-500 rounded-md focus:border-red-500 text-red-900 placeholder-red-700 bg-red-50 file:text-primary-700 file:font-semibold file:px-4 file:py-2 file:mr-6 file:rounded-md hover:file:bg-primary-100 file:border-none file:bg-primary-200 text-sm",
#       else:
...
#     "#{if has_error, do: "has-error", else: ""} focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded disabled:opacity-50"
#   end
...
#     do: "border-red-300 text-red-900 placeholder-red-300 focus:outline-none focus:ring-red-500 focus:border-red-500"
