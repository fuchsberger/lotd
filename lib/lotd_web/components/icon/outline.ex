defmodule LotdWeb.Components.Icon.Outline do
  @moduledoc """
  Icon name can be the function or passed in as a type eg.
  <Icon.Solid.home class="w-5 h-5" />
  <Icon.Solid.render icon="home" class="w-5 h-5" />

  <Icon.Outline.home class="w-6 h-6" />
  <Icon.Outline.render icon="home" class="w-6 h-6" />
  """
